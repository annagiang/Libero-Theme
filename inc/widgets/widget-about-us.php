<?php
class libero_about_widget extends WP_Widget {
	
	function libero_about_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget-about-us', 'description' => 'A widget that show about us' );

		/* Create the widget. */
		parent::__construct( 'libero-about-widget', 'Libero - About', $widget_ops);	
	}
	...
	function widget($args, $instance) {
		...
		$html .= '<div class="text-center libero_about_img">';
			$html .= '<img class="img-circle" src="'. wp_get_attachment_url($instance['avatar']) .'" alt="">';
		$html .= '</div>';
		}
		
		$html .= '<div class="libero-about-detail">';
			if( !empty($instance['description']) ) {
				$html .= wpautop( $instance['description']);
			}
		$html .= '</div>';
	...
	function form($instance) {
		...
		<br /><br />
		<label><?php esc_html_e('Avatar','libero') ?>:</label>
		<?php
			rs::upload(
				array(
		...
		?>
		<br /><br />
		<label><?php esc_html_e('Description','libero') ?>:
...
add_action( 'widgets_init', 'libero_create_about_widget' );

function libero_create_about_widget(){
	return register_widget("libero_about_widget");
}