...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-no"><?php _e( 'No.', 'libero' ); ?></th>
			<th class="product-name"><?php _e( 'Product', 'libero' ); ?></th>
			<th class="product-total"><?php _e( 'Total', 'libero' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th colspan="2"><?php _e( 'Subtotal', 'libero' ); ?></th>
		...
		<tr class="order-total">
			<th colspan="2"><?php _e( 'Total', 'libero' ); ?></th>
