...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		<?php
			...
			$layout = get_theme_mod('libero_search_layout') ? get_theme_mod('libero_search_layout') : 3;
			$is_sidebar = $layout == 2 || $layout == 3;
			$sidebar = get_theme_mod('libero_search_sidebar') ? get_theme_mod('libero_search_sidebar') : 'sidebar-1';
			
			$template = get_theme_mod('libero_search_template') ? get_theme_mod('libero_search_template') : 'large';
			
			$numberpost = get_theme_mod('libero_search_numberpost') ? get_theme_mod('libero_cat_numberpost') : 10;
			$excerpt_length = get_theme_mod('libero_search_excerpt_length') ? get_theme_mod('libero_search_excerpt_length') : 30;
			$pagenavi = get_theme_mod('libero_search_pagenavi') ? get_theme_mod('libero_search_pagenavi') : 'number';
			$number_loadmore = get_theme_mod('libero_search_number_loadmore') ? get_theme_mod('libero_search_number_loadmore') : 4;
			$columns = get_theme_mod('libero_search_columns') ? get_theme_mod('libero_search_columns') : 2;
			if( ! $columns ) $columns = 2;
			$columns = 12/$columns;
			
			$libero_attr['is_hidden_thumbnail'] = get_theme_mod('search_hidden_thumbnail');
			$libero_attr['is_hidden_category'] = get_theme_mod('search_hidden_category');
			$libero_attr['is_hidden_date'] = get_theme_mod('search_hidden_date');
			$libero_attr['is_hidden_comment'] = get_theme_mod('search_hidden_comment');
			$libero_attr['is_hidden_excerpt'] = get_theme_mod('search_hidden_excerpt');
			$libero_attr['is_hidden_read_more'] = get_theme_mod('search_hidden_read_more');
			$libero_attr['is_hidden_share'] = get_theme_mod('search_hidden_share');
